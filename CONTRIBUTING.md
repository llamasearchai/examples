...
Thank you for your interest in contributing to Examples! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Examples:
...
3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/examples.git
   ```
...
By contributing to Examples, you agree that your contributions will be licensed under the project's MIT License.
